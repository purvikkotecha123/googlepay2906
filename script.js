...
const baseRequest = {
  ...
  function getGooglePaymentsClient() {
    console.log('inside getGooglePaymentsClient');
  ...
  async function onGooglePayLoaded() {
    console.log('inside onGooglePayLoaded');
